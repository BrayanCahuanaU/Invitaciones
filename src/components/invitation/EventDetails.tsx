      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-3xl mx-auto text-left">
        ...
        <div className="bg-[var(--inv-surface)]/40 backdrop-blur-md rounded-xl p-6 border border-white/8">
          <div className="flex items-center gap-2 mb-4">
            <MapPin className="w-5 h-5 text-[#D8A718]" />
          ...
          <a
            ...
            className="inline-flex items-center gap-2 mt-2 rounded-full border border-[#D8A718] px-6 py-2 text-sm text-[#D8A718] hover:bg-[#D8A718]/10 transition-colors"
          >
