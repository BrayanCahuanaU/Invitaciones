  ...
  return (
    <div className="relative w-full h-screen min-h-[600px] overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center gap-8 sm:gap-12 text-center px-4">
        <p className="uppercase tracking-[0.3em] text-sm sm:text-base md:text-lg text-[#A8A8A8]">
          {motivo}
        </p>
        ...
        <button
          ...
          className="animate-bounce rounded-full border border-[#4A4A4A] p-2 sm:p-3 text-[#F2F2F2] bg-[#171717]/50 backdrop-blur-sm hover:border-[#D8A718] hover:bg-[#D8A718]/10 transition-all duration-300"
